...
insert into roll values(1,1,'감독','감독',13);
insert into roll values(2,1,'주연','기택',4);
insert into roll values(3,1,'조연','동익',6);
insert into roll values(4,1,'조연','기우',3);
insert into roll values(5,1,'조연','기정',2);
insert into roll values(6,1,'조연','문광',7);
insert into roll values(7,1,'조연','연교',5);

insert into roll values(8,2,'감독','감독',14);
insert into roll values(9,2,'주연','이정출',4);
insert into roll values(10,2,'조연','김우진',9);
insert into roll values(11,2,'조연','연계순',8);
